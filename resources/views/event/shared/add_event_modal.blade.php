...
<style>
  body.light-backdrop .modal-backdrop.show { opacity: .15; }
  body.light-backdrop .modal-backdrop { background-color: #000; }
</style>

<script>
  const addEventModal = document.getElementById('addEventModal');

  addEventModal.addEventListener('show.bs.modal', () => {
    document.body.classList.add('light-backdrop');
  });
