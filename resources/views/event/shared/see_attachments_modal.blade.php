...
<style>
  body.light-backdrop-attachments .modal-backdrop.show { opacity: .15; }
  body.light-backdrop-attachments .modal-backdrop { background-color: #000; }
</style>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (seeAttachmentsModal) {
      seeAttachmentsModal.addEventListener('show.bs.modal', () => {
        document.body.classList.add('light-backdrop-attachments');
      });

      seeAttachmentsModal.addEventListener('hidden.bs.modal', () => {
        document.body.classList.remove('light-backdrop-attachments');
      });
    }
  });
</script>
